<template>
    <div>
        <h1 class="mb-3 text-90 font-normal text-2xl">Editar Configuração</h1>
        <div class="card overflow-hidden">
            <form @submit.prevent="update">
                <div class="flex border-b border-40">
                    <div class="w-1/5 px-8 py-6">
                        <label class="inline-block text-80 h-9 pt-2">Nome</label>
                        <p class="text-sm leading-normal text-80 italic"></p>
                    </div>
                    <div class="w-1/2 px-8 py-6">
                        <input id="name" dusk="name" placeholder="Nome" type="text" class="w-full form-control form-input form-input-bordered" v-model="configuration.key">
                    </div>
                </div>
                <div class="flex border-b border-40">
                    <div class="w-1/5 px-8 py-6">
                        <label class="inline-block text-80 h-9 pt-2">Valor</label>
                        <p class="text-sm leading-normal text-80 italic"></p>
                    </div>
                    <div class="w-1/2 px-8 py-6">
                        <input id="value" dusk="value" placeholder="Valor" type="text" class="w-full form-control form-input form-input-bordered" v-model="configuration.value">
                    </div>
                </div>
